                ...
                [
                    ...
                    'children' => [
                        [
                            ...
                            'linkable_slug' => 'don-vi-ban-chu-nhiem-khoa',
                            'target' => '_self',
                            'sort_order' => 1,
                            'is_active' => true,
                        ],
                        [
                            ...
                            'type' => 'post',
                            'linkable_type' => Post::class,
                            'linkable_slug' => 'don-vi-bo-mon-he-thong-thong-tin',
                            'target' => '_self',
                            'sort_order' => 2,
                            'is_active' => true,
                        ],
                        [
                            ...
                            'type' => 'post',
                            'linkable_type' => Post::class,
                            'linkable_slug' => 'don-vi-bo-mon-khoa-hoc-may-tinh',
                            'target' => '_self',
                            'sort_order' => 3,
                            'is_active' => true,
                        ],
                        [
                            ...
                            'type' => 'post',
                            'linkable_type' => Post::class,
                            'linkable_slug' => 'don-vi-bo-mon-ky-thuat-may-tinh',
                            'target' => '_self',
                            'sort_order' => 4,
                            'is_active' => true,
                        ],
                        [
                            ...
                            'type' => 'post',
                            'linkable_type' => Post::class,
                            'linkable_slug' => 'don-vi-bo-mon-tin-hoc-dai-cuong',
                            'target' => '_self',
                            'sort_order' => 5,
                            'is_active' => true,
                        ],
                        [
                            ...
                            'type' => 'post',
                            'linkable_type' => Post::class,
                            'linkable_slug' => 'don-vi-bo-mon-truyen-thong-va-mang-may-tinh',
                            'target' => '_self',
                            'sort_order' => 6,
                            'is_active' => true,
                        ],
                        [
                            ...
                            'type' => 'post',
                            'linkable_type' => Post::class,
                            'linkable_slug' => 'don-vi-ban-chap-hanh-cong-doan',
                            'target' => '_self',
                            'sort_order' => 7,
                            'is_active' => true,
                        ],
                        [
                            ...
                            'type' => 'post',
                            'linkable_type' => Post::class,
                            'linkable_slug' => 'don-vi-lien-chi-doan-khoa-cong-nghe-thong-tin',
                            'target' => '_self',
                            'sort_order' => 8,
                            'is_active' => true,
                        ],
                ...
                [
                    ...
                    'children' => [
                        [
                            ...
                            'type' => 'post',
                            'linkable_type' => Post::class,
                            'linkable_slug' => 'chuyen-nganh-cong-nghe-thong-tin',
                            'target' => '_self',
                            'sort_order' => 1,
                            'is_active' => true,
                        ],
                        [
                            ...
                            'type' => 'post',
                            'linkable_type' => Post::class,
                            'linkable_slug' => 'chuyen-nganh-cong-nghe-phan-mem',
                            'target' => '_self',
                            'sort_order' => 2,
                            'is_active' => true,
                        ],
                        [
                            ...
                            'type' => 'post',
                            'linkable_type' => Post::class,
                            'linkable_slug' => 'chuyen-nganh-truyen-thong-va-mang-may-tinh',
                            'target' => '_self',
                            'sort_order' => 3,
                            'is_active' => true,
                        ],
