...
* @route '/cms/units'
*/
const StoreUnitController = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/cms/units'
*/
StoreUnitController.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: StoreUnitController.url(options),
    method: 'post',
})
...
* @route '/cms/units'
*/
const StoreUnitControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/cms/units'
*/
StoreUnitControllerForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: StoreUnitController.url(options),
    method: 'post',
})
