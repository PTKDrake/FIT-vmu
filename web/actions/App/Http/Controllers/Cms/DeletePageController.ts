...
DeletePageController.url = (
  ...
  return (
    DeletePageController.definition.url
 ...
 * @route '/cms/pages/{page}'
 */
const DeletePageControllerForm = (
  args:
    | { page: number | { id: number } }
    | [page: number | { id: number }]
    | number
 ...
 * @route '/cms/pages/{page}'
 */
DeletePageControllerForm.delete = (
  args:
    | { page: number | { id: number } }
    | [page: number | { id: number }]
    | number
