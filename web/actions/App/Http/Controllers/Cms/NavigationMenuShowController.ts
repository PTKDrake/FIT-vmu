 ...
 */
const NavigationMenuShowController = (
  args:
 ...
 * @route '/cms/navigation/{navigationMenu}'
 */
NavigationMenuShowController.url = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
  ...
  return (
    NavigationMenuShowController.definition.url
 ...
 * @route '/cms/navigation/{navigationMenu}'
 */
NavigationMenuShowController.get = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
 ...
 * @route '/cms/navigation/{navigationMenu}'
 */
NavigationMenuShowController.head = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
 ...
 * @route '/cms/navigation/{navigationMenu}'
 */
const NavigationMenuShowControllerForm = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
 ...
 * @route '/cms/navigation/{navigationMenu}'
 */
NavigationMenuShowControllerForm.get = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
 ...
 * @route '/cms/navigation/{navigationMenu}'
 */
NavigationMenuShowControllerForm.head = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
