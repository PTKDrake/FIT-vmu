 ...
 */
const PostCategoriesIndexController = (
 ...
 * @route '/cms/post-categories'
 */
PostCategoriesIndexController.get = (
  options?: RouteQueryOptions,
): RouteDefinition<"get"> => ({
  url: PostCategoriesIndexController.url(options),
  method: "get",
 ...
 * @route '/cms/post-categories'
 */
PostCategoriesIndexController.head = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/post-categories'
 */
const PostCategoriesIndexControllerForm = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/post-categories'
 */
PostCategoriesIndexControllerForm.get = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
  action: PostCategoriesIndexController.url(options),
  method: "get",
 ...
 * @route '/cms/post-categories'
 */
PostCategoriesIndexControllerForm.head = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
