 ...
 */
const StaffProfilesIndexController = (
 ...
 * @route '/cms/staff-profiles'
 */
StaffProfilesIndexController.get = (
  options?: RouteQueryOptions,
): RouteDefinition<"get"> => ({
  url: StaffProfilesIndexController.url(options),
  method: "get",
 ...
 * @route '/cms/staff-profiles'
 */
StaffProfilesIndexController.head = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/staff-profiles'
 */
const StaffProfilesIndexControllerForm = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/staff-profiles'
 */
StaffProfilesIndexControllerForm.get = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
  action: StaffProfilesIndexController.url(options),
  method: "get",
 ...
 * @route '/cms/staff-profiles'
 */
StaffProfilesIndexControllerForm.head = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
