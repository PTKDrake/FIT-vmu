 ...
 */
const PostCreatePageController = (
 ...
 * @route '/cms/posts/create'
 */
const PostCreatePageControllerForm = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/posts/create'
 */
PostCreatePageControllerForm.get = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
  action: PostCreatePageController.url(options),
  method: "get",
 ...
 * @route '/cms/posts/create'
 */
PostCreatePageControllerForm.head = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
