 ...
 * @route '/cms/positions'
 */
const PositionsIndexController = (
 ...
 * @route '/cms/positions'
 */
const PositionsIndexControllerForm = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/positions'
 */
PositionsIndexControllerForm.get = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
  action: PositionsIndexController.url(options),
  method: "get",
 ...
 * @route '/cms/positions'
 */
PositionsIndexControllerForm.head = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
