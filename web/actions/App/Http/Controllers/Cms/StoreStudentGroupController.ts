...
*/
const StoreStudentGroupController = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/cms/student-groups'
*/
StoreStudentGroupController.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: StoreStudentGroupController.url(options),
    method: 'post',
})
...
* @route '/cms/student-groups'
*/
const StoreStudentGroupControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/cms/student-groups'
*/
StoreStudentGroupControllerForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: StoreStudentGroupController.url(options),
    method: 'post',
})
