...
*/
const PingCmsRealtimeController = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/cms/realtime/ping'
*/
PingCmsRealtimeController.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: PingCmsRealtimeController.url(options),
    method: 'post',
})
...
* @route '/cms/realtime/ping'
*/
const PingCmsRealtimeControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/cms/realtime/ping'
*/
PingCmsRealtimeControllerForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: PingCmsRealtimeController.url(options),
    method: 'post',
})
