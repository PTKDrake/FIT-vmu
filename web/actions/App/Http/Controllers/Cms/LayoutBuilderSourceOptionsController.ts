 ...
 */
const LayoutBuilderSourceOptionsController = (
  args:
 ...
 * @route '/cms/layout-builder/sources/{source}'
 */
LayoutBuilderSourceOptionsController.url = (
  args:
    | { source: string | number }
    | [source: string | number]
    | string
  ...
  return (
    LayoutBuilderSourceOptionsController.definition.url
 ...
 * @route '/cms/layout-builder/sources/{source}'
 */
LayoutBuilderSourceOptionsController.get = (
  args:
    | { source: string | number }
    | [source: string | number]
    | string
 ...
 * @route '/cms/layout-builder/sources/{source}'
 */
LayoutBuilderSourceOptionsController.head = (
  args:
    | { source: string | number }
    | [source: string | number]
    | string
 ...
 * @route '/cms/layout-builder/sources/{source}'
 */
const LayoutBuilderSourceOptionsControllerForm = (
  args:
    | { source: string | number }
    | [source: string | number]
    | string
 ...
 * @route '/cms/layout-builder/sources/{source}'
 */
LayoutBuilderSourceOptionsControllerForm.get = (
  args:
    | { source: string | number }
    | [source: string | number]
    | string
 ...
 * @route '/cms/layout-builder/sources/{source}'
 */
LayoutBuilderSourceOptionsControllerForm.head = (
  args:
    | { source: string | number }
    | [source: string | number]
    | string
...
LayoutBuilderSourceOptionsController.form =
  LayoutBuilderSourceOptionsControllerForm;
