...
* @route '/cms/positions'
*/
const StorePositionController = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/cms/positions'
*/
StorePositionController.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: StorePositionController.url(options),
    method: 'post',
})
...
* @route '/cms/positions'
*/
const StorePositionControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/cms/positions'
*/
StorePositionControllerForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: StorePositionController.url(options),
    method: 'post',
})
