 ...
 */
const DeleteNavigationMenuController = (
  args:
 ...
 * @route '/cms/navigation/{navigationMenu}'
 */
DeleteNavigationMenuController.url = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
  ...
  return (
    DeleteNavigationMenuController.definition.url
 ...
 * @route '/cms/navigation/{navigationMenu}'
 */
DeleteNavigationMenuController.delete = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
 ...
 * @route '/cms/navigation/{navigationMenu}'
 */
const DeleteNavigationMenuControllerForm = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
 ...
 * @route '/cms/navigation/{navigationMenu}'
 */
DeleteNavigationMenuControllerForm.delete = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
