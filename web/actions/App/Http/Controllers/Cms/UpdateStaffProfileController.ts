 ...
 */
const UpdateStaffProfileController = (
  args:
 ...
 * @route '/cms/staff-profiles/{staffProfile}'
 */
UpdateStaffProfileController.url = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
  ...
  return (
    UpdateStaffProfileController.definition.url
 ...
 * @route '/cms/staff-profiles/{staffProfile}'
 */
UpdateStaffProfileController.patch = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
 ...
 * @route '/cms/staff-profiles/{staffProfile}'
 */
const UpdateStaffProfileControllerForm = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
 ...
 * @route '/cms/staff-profiles/{staffProfile}'
 */
UpdateStaffProfileControllerForm.patch = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
