...
*/
const StoreNavigationMenuController = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/cms/navigation'
*/
StoreNavigationMenuController.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: StoreNavigationMenuController.url(options),
    method: 'post',
})
...
* @route '/cms/navigation'
*/
const StoreNavigationMenuControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/cms/navigation'
*/
StoreNavigationMenuControllerForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: StoreNavigationMenuController.url(options),
    method: 'post',
})
