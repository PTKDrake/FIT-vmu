...
*/
const NavigationMenusIndexController = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/cms/navigation'
*/
NavigationMenusIndexController.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: NavigationMenusIndexController.url(options),
    method: 'get',
})
...
* @route '/cms/navigation'
*/
NavigationMenusIndexController.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: NavigationMenusIndexController.url(options),
    method: 'head',
})
...
* @route '/cms/navigation'
*/
const NavigationMenusIndexControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/cms/navigation'
*/
NavigationMenusIndexControllerForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: NavigationMenusIndexController.url(options),
    method: 'get',
})
...
* @route '/cms/navigation'
*/
NavigationMenusIndexControllerForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
