 ...
 */
const SetDefaultSiteLayoutController = (
  args:
 ...
 * @route '/cms/layouts/{siteLayout}/default'
 */
SetDefaultSiteLayoutController.url = (
  args:
    | { siteLayout: number | { id: number } }
    | [siteLayout: number | { id: number }]
    | number
  ...
  return (
    SetDefaultSiteLayoutController.definition.url
 ...
 * @route '/cms/layouts/{siteLayout}/default'
 */
SetDefaultSiteLayoutController.patch = (
  args:
    | { siteLayout: number | { id: number } }
    | [siteLayout: number | { id: number }]
    | number
 ...
 * @route '/cms/layouts/{siteLayout}/default'
 */
const SetDefaultSiteLayoutControllerForm = (
  args:
    | { siteLayout: number | { id: number } }
    | [siteLayout: number | { id: number }]
    | number
 ...
 * @route '/cms/layouts/{siteLayout}/default'
 */
SetDefaultSiteLayoutControllerForm.patch = (
  args:
    | { siteLayout: number | { id: number } }
    | [siteLayout: number | { id: number }]
    | number
