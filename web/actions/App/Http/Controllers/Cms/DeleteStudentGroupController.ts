 ...
 */
const DeleteStudentGroupController = (
  args:
    | { student_group: number | { id: number } }
    | [student_group: number | { id: number }]
    | number
    | { id: number },
 ...
 * @route '/cms/student-groups/{student_group}'
 */
DeleteStudentGroupController.url = (
  args:
    | { student_group: number | { id: number } }
    | [student_group: number | { id: number }]
    | number
  ...
  const parsedArgs = {
    student_group:
      typeof args.student_group === "object"
        ? args.student_group.id
        : args.student_group,
  };

  return (
    DeleteStudentGroupController.definition.url
 ...
 * @route '/cms/student-groups/{student_group}'
 */
DeleteStudentGroupController.delete = (
  args:
    | { student_group: number | { id: number } }
    | [student_group: number | { id: number }]
    | number
 ...
 * @route '/cms/student-groups/{student_group}'
 */
const DeleteStudentGroupControllerForm = (
  args:
    | { student_group: number | { id: number } }
    | [student_group: number | { id: number }]
    | number
 ...
 * @route '/cms/student-groups/{student_group}'
 */
DeleteStudentGroupControllerForm.delete = (
  args:
    | { student_group: number | { id: number } }
    | [student_group: number | { id: number }]
    | number
