 ...
 */
const RolesPermissionsIndexController = (
 ...
 * @route '/cms/roles-permissions'
 */
RolesPermissionsIndexController.get = (
  options?: RouteQueryOptions,
): RouteDefinition<"get"> => ({
  url: RolesPermissionsIndexController.url(options),
  method: "get",
 ...
 * @route '/cms/roles-permissions'
 */
RolesPermissionsIndexController.head = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/roles-permissions'
 */
const RolesPermissionsIndexControllerForm = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/roles-permissions'
 */
RolesPermissionsIndexControllerForm.get = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
  action: RolesPermissionsIndexController.url(options),
  method: "get",
 ...
 * @route '/cms/roles-permissions'
 */
RolesPermissionsIndexControllerForm.head = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
