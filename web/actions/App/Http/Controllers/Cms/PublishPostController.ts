...
PublishPostController.url = (
  ...
  return (
    PublishPostController.definition.url
 ...
 * @route '/cms/posts/{post}/publish'
 */
const PublishPostControllerForm = (
  args:
    | { post: number | { id: number } }
    | [post: number | { id: number }]
    | number
 ...
 * @route '/cms/posts/{post}/publish'
 */
PublishPostControllerForm.patch = (
  args:
    | { post: number | { id: number } }
    | [post: number | { id: number }]
    | number
