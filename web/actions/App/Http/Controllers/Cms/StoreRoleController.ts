...
*/
const StoreRoleController = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/cms/roles-permissions'
*/
StoreRoleController.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: StoreRoleController.url(options),
    method: 'post',
})
...
* @route '/cms/roles-permissions'
*/
const StoreRoleControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/cms/roles-permissions'
*/
StoreRoleControllerForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: StoreRoleController.url(options),
    method: 'post',
})
