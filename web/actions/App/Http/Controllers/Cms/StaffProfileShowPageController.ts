 ...
 */
const StaffProfileShowPageController = (
  args:
 ...
 * @route '/cms/staff-profiles/{staffProfile}'
 */
StaffProfileShowPageController.url = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
  ...
  return (
    StaffProfileShowPageController.definition.url
 ...
 * @route '/cms/staff-profiles/{staffProfile}'
 */
StaffProfileShowPageController.get = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
 ...
 * @route '/cms/staff-profiles/{staffProfile}'
 */
StaffProfileShowPageController.head = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
 ...
 * @route '/cms/staff-profiles/{staffProfile}'
 */
const StaffProfileShowPageControllerForm = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
 ...
 * @route '/cms/staff-profiles/{staffProfile}'
 */
StaffProfileShowPageControllerForm.get = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
 ...
 * @route '/cms/staff-profiles/{staffProfile}'
 */
StaffProfileShowPageControllerForm.head = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
