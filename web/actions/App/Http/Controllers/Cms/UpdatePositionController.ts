 ...
 */
const UpdatePositionController = (
  args:
...
UpdatePositionController.url = (
  ...
  return (
    UpdatePositionController.definition.url
 ...
 * @route '/cms/positions/{position}'
 */
UpdatePositionController.patch = (
  args:
    | { position: number | { id: number } }
    | [position: number | { id: number }]
    | number
 ...
 * @route '/cms/positions/{position}'
 */
const UpdatePositionControllerForm = (
  args:
    | { position: number | { id: number } }
    | [position: number | { id: number }]
    | number
 ...
 * @route '/cms/positions/{position}'
 */
UpdatePositionControllerForm.patch = (
  args:
    | { position: number | { id: number } }
    | [position: number | { id: number }]
    | number
