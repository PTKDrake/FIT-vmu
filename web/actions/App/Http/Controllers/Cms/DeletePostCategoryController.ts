 ...
 */
const DeletePostCategoryController = (
  args:
 ...
 * @route '/cms/post-categories/{post_category}'
 */
DeletePostCategoryController.url = (
  args:
    | { post_category: number | { id: number } }
    | [post_category: number | { id: number }]
    | number
  ...
  return (
    DeletePostCategoryController.definition.url
 ...
 * @route '/cms/post-categories/{post_category}'
 */
DeletePostCategoryController.delete = (
  args:
    | { post_category: number | { id: number } }
    | [post_category: number | { id: number }]
    | number
 ...
 * @route '/cms/post-categories/{post_category}'
 */
const DeletePostCategoryControllerForm = (
  args:
    | { post_category: number | { id: number } }
    | [post_category: number | { id: number }]
    | number
 ...
 * @route '/cms/post-categories/{post_category}'
 */
DeletePostCategoryControllerForm.delete = (
  args:
    | { post_category: number | { id: number } }
    | [post_category: number | { id: number }]
    | number
