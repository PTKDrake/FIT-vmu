...
*/
const UnitCreatePageController = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/cms/units/create'
*/
UnitCreatePageController.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: UnitCreatePageController.url(options),
    method: 'get',
})
...
* @route '/cms/units/create'
*/
UnitCreatePageController.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: UnitCreatePageController.url(options),
    method: 'head',
})
...
* @route '/cms/units/create'
*/
const UnitCreatePageControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/cms/units/create'
*/
UnitCreatePageControllerForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: UnitCreatePageController.url(options),
    method: 'get',
})
...
* @route '/cms/units/create'
*/
UnitCreatePageControllerForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
