 ...
 */
const SyncNavigationMenuItemsController = (
  args:
 ...
 * @route '/cms/navigation/{navigationMenu}/items'
 */
SyncNavigationMenuItemsController.url = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
  ...
  return (
    SyncNavigationMenuItemsController.definition.url
 ...
 * @route '/cms/navigation/{navigationMenu}/items'
 */
SyncNavigationMenuItemsController.patch = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
 ...
 * @route '/cms/navigation/{navigationMenu}/items'
 */
const SyncNavigationMenuItemsControllerForm = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
 ...
 * @route '/cms/navigation/{navigationMenu}/items'
 */
SyncNavigationMenuItemsControllerForm.patch = (
  args:
    | { navigationMenu: number | { id: number } }
    | [navigationMenu: number | { id: number }]
    | number
