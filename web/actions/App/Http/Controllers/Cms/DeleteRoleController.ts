...
DeleteRoleController.url = (
  ...
  return (
    DeleteRoleController.definition.url
 ...
 * @route '/cms/roles-permissions/{role}'
 */
const DeleteRoleControllerForm = (
  args:
    | { role: number | { id: number } }
    | [role: number | { id: number }]
    | number
 ...
 * @route '/cms/roles-permissions/{role}'
 */
DeleteRoleControllerForm.delete = (
  args:
    | { role: number | { id: number } }
    | [role: number | { id: number }]
    | number
