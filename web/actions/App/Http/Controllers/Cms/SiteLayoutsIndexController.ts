 ...
 * @route '/cms/layouts'
 */
const SiteLayoutsIndexController = (
 ...
 * @route '/cms/layouts'
 */
SiteLayoutsIndexController.get = (
  options?: RouteQueryOptions,
): RouteDefinition<"get"> => ({
  url: SiteLayoutsIndexController.url(options),
  method: "get",
 ...
 * @route '/cms/layouts'
 */
SiteLayoutsIndexController.head = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/layouts'
 */
const SiteLayoutsIndexControllerForm = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/layouts'
 */
SiteLayoutsIndexControllerForm.get = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
  action: SiteLayoutsIndexController.url(options),
  method: "get",
 ...
 * @route '/cms/layouts'
 */
SiteLayoutsIndexControllerForm.head = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
