 ...
 */
const DeletePositionController = (
  args:
...
DeletePositionController.url = (
  ...
  const parsedArgs = {
    position:
      typeof args.position === "object" ? args.position.id : args.position,
  };

  return (
    DeletePositionController.definition.url
 ...
 * @route '/cms/positions/{position}'
 */
DeletePositionController.delete = (
  args:
    | { position: number | { id: number } }
    | [position: number | { id: number }]
    | number
 ...
 * @route '/cms/positions/{position}'
 */
const DeletePositionControllerForm = (
  args:
    | { position: number | { id: number } }
    | [position: number | { id: number }]
    | number
 ...
 * @route '/cms/positions/{position}'
 */
DeletePositionControllerForm.delete = (
  args:
    | { position: number | { id: number } }
    | [position: number | { id: number }]
    | number
