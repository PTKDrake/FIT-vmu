 ...
 */
const CloneSiteLayoutController = (
  args:
...
CloneSiteLayoutController.url = (
  ...
  return (
    CloneSiteLayoutController.definition.url
 ...
 * @route '/cms/layouts/{siteLayout}/clone'
 */
CloneSiteLayoutController.post = (
  args:
    | { siteLayout: number | { id: number } }
    | [siteLayout: number | { id: number }]
    | number
 ...
 * @route '/cms/layouts/{siteLayout}/clone'
 */
const CloneSiteLayoutControllerForm = (
  args:
    | { siteLayout: number | { id: number } }
    | [siteLayout: number | { id: number }]
    | number
 ...
 * @route '/cms/layouts/{siteLayout}/clone'
 */
CloneSiteLayoutControllerForm.post = (
  args:
    | { siteLayout: number | { id: number } }
    | [siteLayout: number | { id: number }]
    | number
