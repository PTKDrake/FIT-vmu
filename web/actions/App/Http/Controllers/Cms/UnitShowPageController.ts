...
UnitShowPageController.url = (
  ...
  return (
    UnitShowPageController.definition.url
 ...
 * @route '/cms/units/{unit}'
 */
const UnitShowPageControllerForm = (
  args:
    | { unit: number | { id: number } }
    | [unit: number | { id: number }]
    | number
 ...
 * @route '/cms/units/{unit}'
 */
UnitShowPageControllerForm.get = (
  args:
    | { unit: number | { id: number } }
    | [unit: number | { id: number }]
    | number
 ...
 * @route '/cms/units/{unit}'
 */
UnitShowPageControllerForm.head = (
  args:
    | { unit: number | { id: number } }
    | [unit: number | { id: number }]
    | number
