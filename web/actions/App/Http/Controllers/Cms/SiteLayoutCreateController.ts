 ...
 */
const SiteLayoutCreateController = (
 ...
 * @route '/cms/layouts/create'
 */
SiteLayoutCreateController.get = (
  options?: RouteQueryOptions,
): RouteDefinition<"get"> => ({
  url: SiteLayoutCreateController.url(options),
  method: "get",
 ...
 * @route '/cms/layouts/create'
 */
SiteLayoutCreateController.head = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/layouts/create'
 */
const SiteLayoutCreateControllerForm = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/layouts/create'
 */
SiteLayoutCreateControllerForm.get = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
  action: SiteLayoutCreateController.url(options),
  method: "get",
 ...
 * @route '/cms/layouts/create'
 */
SiteLayoutCreateControllerForm.head = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
