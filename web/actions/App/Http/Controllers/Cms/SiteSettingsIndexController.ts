...
* @route '/cms/settings'
*/
const SiteSettingsIndexController = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/cms/settings'
*/
SiteSettingsIndexController.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: SiteSettingsIndexController.url(options),
    method: 'get',
})
...
* @route '/cms/settings'
*/
SiteSettingsIndexController.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: SiteSettingsIndexController.url(options),
    method: 'head',
})
...
* @route '/cms/settings'
*/
const SiteSettingsIndexControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/cms/settings'
*/
SiteSettingsIndexControllerForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: SiteSettingsIndexController.url(options),
    method: 'get',
})
...
* @route '/cms/settings'
*/
SiteSettingsIndexControllerForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
