...
*/
const StaffProfileCreatePageController = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/cms/staff-profiles/create'
*/
StaffProfileCreatePageController.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: StaffProfileCreatePageController.url(options),
    method: 'get',
})
...
* @route '/cms/staff-profiles/create'
*/
StaffProfileCreatePageController.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: StaffProfileCreatePageController.url(options),
    method: 'head',
})
...
* @route '/cms/staff-profiles/create'
*/
const StaffProfileCreatePageControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/cms/staff-profiles/create'
*/
StaffProfileCreatePageControllerForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: StaffProfileCreatePageController.url(options),
    method: 'get',
})
...
* @route '/cms/staff-profiles/create'
*/
StaffProfileCreatePageControllerForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
