 ...
 */
const UserCreatePageController = (
 ...
 * @route '/cms/users/create'
 */
const UserCreatePageControllerForm = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/users/create'
 */
UserCreatePageControllerForm.get = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
  action: UserCreatePageController.url(options),
  method: "get",
 ...
 * @route '/cms/users/create'
 */
UserCreatePageControllerForm.head = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
