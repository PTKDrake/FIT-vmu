 ...
 */
const StudentGroupsIndexController = (
 ...
 * @route '/cms/student-groups'
 */
StudentGroupsIndexController.get = (
  options?: RouteQueryOptions,
): RouteDefinition<"get"> => ({
  url: StudentGroupsIndexController.url(options),
  method: "get",
 ...
 * @route '/cms/student-groups'
 */
StudentGroupsIndexController.head = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/student-groups'
 */
const StudentGroupsIndexControllerForm = (
  options?: RouteQueryOptions,
 ...
 * @route '/cms/student-groups'
 */
StudentGroupsIndexControllerForm.get = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
  action: StudentGroupsIndexController.url(options),
  method: "get",
 ...
 * @route '/cms/student-groups'
 */
StudentGroupsIndexControllerForm.head = (
  options?: RouteQueryOptions,
): RouteFormDefinition<"get"> => ({
