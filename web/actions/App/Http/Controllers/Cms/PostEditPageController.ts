...
PostEditPageController.url = (
  ...
  return (
    PostEditPageController.definition.url
 ...
 * @route '/cms/posts/{post}/edit'
 */
const PostEditPageControllerForm = (
  args:
    | { post: number | { id: number } }
    | [post: number | { id: number }]
    | number
 ...
 * @route '/cms/posts/{post}/edit'
 */
PostEditPageControllerForm.get = (
  args:
    | { post: number | { id: number } }
    | [post: number | { id: number }]
    | number
 ...
 * @route '/cms/posts/{post}/edit'
 */
PostEditPageControllerForm.head = (
  args:
    | { post: number | { id: number } }
    | [post: number | { id: number }]
    | number
