...
* @route '/cms/posts'
*/
const StorePostController = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/cms/posts'
*/
StorePostController.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: StorePostController.url(options),
    method: 'post',
})
...
* @route '/cms/posts'
*/
const StorePostControllerForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/cms/posts'
*/
StorePostControllerForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: StorePostController.url(options),
    method: 'post',
})
