 ...
 */
const UpdateStudentGroupController = (
  args:
 ...
 * @route '/cms/student-groups/{student_group}'
 */
UpdateStudentGroupController.url = (
  args:
    | { student_group: number | { id: number } }
    | [student_group: number | { id: number }]
    | number
  ...
  return (
    UpdateStudentGroupController.definition.url
 ...
 * @route '/cms/student-groups/{student_group}'
 */
UpdateStudentGroupController.patch = (
  args:
    | { student_group: number | { id: number } }
    | [student_group: number | { id: number }]
    | number
 ...
 * @route '/cms/student-groups/{student_group}'
 */
const UpdateStudentGroupControllerForm = (
  args:
    | { student_group: number | { id: number } }
    | [student_group: number | { id: number }]
    | number
 ...
 * @route '/cms/student-groups/{student_group}'
 */
UpdateStudentGroupControllerForm.patch = (
  args:
    | { student_group: number | { id: number } }
    | [student_group: number | { id: number }]
    | number
