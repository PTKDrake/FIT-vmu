...
PageEditorController.url = (
  ...
  return (
    PageEditorController.definition.url
 ...
 * @route '/cms/pages/{page}/edit'
 */
const PageEditorControllerForm = (
  args:
    | { page: number | { id: number } }
    | [page: number | { id: number }]
    | number
