 ...
 */
const StaffProfileEditPageController = (
  args:
 ...
 * @route '/cms/staff-profiles/{staffProfile}/edit'
 */
StaffProfileEditPageController.url = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
  ...
  return (
    StaffProfileEditPageController.definition.url
 ...
 * @route '/cms/staff-profiles/{staffProfile}/edit'
 */
StaffProfileEditPageController.get = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
 ...
 * @route '/cms/staff-profiles/{staffProfile}/edit'
 */
StaffProfileEditPageController.head = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
 ...
 * @route '/cms/staff-profiles/{staffProfile}/edit'
 */
const StaffProfileEditPageControllerForm = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
 ...
 * @route '/cms/staff-profiles/{staffProfile}/edit'
 */
StaffProfileEditPageControllerForm.get = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
 ...
 * @route '/cms/staff-profiles/{staffProfile}/edit'
 */
StaffProfileEditPageControllerForm.head = (
  args:
    | { staffProfile: number | { id: number } }
    | [staffProfile: number | { id: number }]
    | number
