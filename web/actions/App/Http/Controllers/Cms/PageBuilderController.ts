...
PageBuilderController.url = (
  ...
  return (
    PageBuilderController.definition.url
 ...
 * @route '/cms/pages/{page}/builder'
 */
const PageBuilderControllerForm = (
  args:
    | { page: number | { id: number } }
    | [page: number | { id: number }]
    | number
 ...
 * @route '/cms/pages/{page}/builder'
 */
PageBuilderControllerForm.head = (
  args:
    | { page: number | { id: number } }
    | [page: number | { id: number }]
    | number
