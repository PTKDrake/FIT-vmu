 ...
 */
const UpdatePageMetadataController = (
  args:
 ...
 * @route '/cms/pages/{page}/metadata'
 */
UpdatePageMetadataController.url = (
  args:
    | { page: number | { id: number } }
    | [page: number | { id: number }]
    | number
  ...
  return (
    UpdatePageMetadataController.definition.url
 ...
 * @route '/cms/pages/{page}/metadata'
 */
UpdatePageMetadataController.patch = (
  args:
    | { page: number | { id: number } }
    | [page: number | { id: number }]
    | number
 ...
 * @route '/cms/pages/{page}/metadata'
 */
const UpdatePageMetadataControllerForm = (
  args:
    | { page: number | { id: number } }
    | [page: number | { id: number }]
    | number
 ...
 * @route '/cms/pages/{page}/metadata'
 */
UpdatePageMetadataControllerForm.patch = (
  args:
    | { page: number | { id: number } }
    | [page: number | { id: number }]
    | number
