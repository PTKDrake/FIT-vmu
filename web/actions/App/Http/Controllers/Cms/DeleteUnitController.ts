...
DeleteUnitController.url = (
  ...
  return (
    DeleteUnitController.definition.url
 ...
 * @route '/cms/units/{unit}'
 */
const DeleteUnitControllerForm = (
  args:
    | { unit: number | { id: number } }
    | [unit: number | { id: number }]
    | number
 ...
 * @route '/cms/units/{unit}'
 */
DeleteUnitControllerForm.delete = (
  args:
    | { unit: number | { id: number } }
    | [unit: number | { id: number }]
    | number
