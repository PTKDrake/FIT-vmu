...
*/
export const blocknote = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/cms/ai/blocknote'
*/
const blocknoteForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/cms/ai/blocknote'
*/
blocknoteForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: blocknote.url(options),
    method: 'post',
})
