...
export const AboutSectionComponentConfig: PageBuilderComponentConfig<"AboutSection"> =
  {
    ...
    render: ({ className, ...props }) => (
      <AboutSection
        ...
        {...props}
        fallbackIcon={
          <LucideIconRenderer name="School" className="size-16 opacity-55" />
        }
      />
    ),
  };
...
export const FeatureGridComponentConfig: PageBuilderComponentConfig<"FeatureGrid"> =
  {
    ...
    render: ({ badge, header, description, features, columns, className }) => (
      <FeatureSection
        className={className}
        badge={badge}
        header={header}
...
export const StatsSectionComponentConfig: PageBuilderComponentConfig<"StatsSection"> =
  {
    ...
    render: ({ badge, header, description, stats, className }) => (
      <section className={twMerge("space-y-8 py-8 w-full", className)}>
...
export const TimelineSectionComponentConfig: PageBuilderComponentConfig<"TimelineSection"> =
  {
    ...
    render: ({ badge, header, description, steps, className }) => (
      <StepsTimeline
        className={className}
        badge={badge}
        header={header}
...
export const FAQSectionComponentConfig: PageBuilderComponentConfig<"FAQSection"> =
  {
    ...
    render: ({ title, description, items, className }) => (
      <section className={twMerge("space-y-8 py-8 w-full", className)}>
        <div className="space-y-3 text-center">
          <Badge
            intent="outline"
...
export const TestimonialSectionComponentConfig: PageBuilderComponentConfig<"TestimonialSection"> =
  {
    ...
    render: ({ badge, header, description, testimonials, className }) => (
      <section className={twMerge("space-y-8 py-8 w-full", className)}>
        <div className="space-y-3 text-center">
          {badge && (
            <Badge
...
export const CarouselSectionComponentConfig: PageBuilderComponentConfig<"CarouselSection"> =
  {
    ...
    render: ({ badge, header, description, items, className }) => {
      return (
        <section
          className={twMerge("space-y-8 py-8 w-full relative", className)}
        >
          <div className="space-y-3 text-center">
            {badge && (
              <Badge
            ...
            <Carousel opts={{ loop: true, align: "start" }} className="w-full">
              <CarouselContent>
                {items.map((item, index) => (
                  ...
                  >
                    <Card className="overflow-hidden rounded-3xl border border-border bg-overlay py-0 shadow-xs h-full flex flex-col justify-between group">
