...
class CreateStudentGroupAction
{
     ...
     * }  $attributes
     */
    public function __invoke(User $user, array $attributes): StudentGroup
    {
        return DB::transaction(function () use ($user, $attributes): StudentGroup {
            /** @var StudentGroup $studentGroup */
            $studentGroup = StudentGroup::query()->create([
