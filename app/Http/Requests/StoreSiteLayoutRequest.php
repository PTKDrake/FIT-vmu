...
class StoreSiteLayoutRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('create', SiteLayout::class) ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'key' => ['required', 'string', 'max:255', Rule::unique((new SiteLayout)->getTable(), 'key')],
